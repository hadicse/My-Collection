...
DECLARE @SearchStr nvarchar(100) = 'AMi Hadi Bolsi 18012023'
...
WHERE Names LIKE '% % % % %'
```
![image](https://user-images.githubusercontent.com/110928130/235446409-a0d93196-82db-4e81-9cac-4ed1aa2298ea.png)
