...
# টার্নওভার করঃ 
```
কোনো ব্যাক্তি বা প্রতিষ্টান নির্দিষ্ট সময়ে করযোগ্য পণ্য বা সেবা সরবরাহ থেকে যে পরিমাণ অর্থ প্রাপ্ত হয় তাকে টার্নওভার কর বলে।
...
ষাট লক্ষ টাকার নিম্নে হলে তাকে টার্ণওভার কর তালিকাভুক্ত হয়ে মোট টার্ণওভারের উপর চার শতাংশ হারে কর প্রদান করতে হয়। এই করকেই টার্ণওভার কর বলা হয়। 
...
# Input-Output CoEfficient (4.3) (ইনপুট-আউটপুট সহগ-4.3)
...
# Sales Invoice (কর চালান পত্র-৬.৩):
